...
import bpc.dis.utilities.PermissionHelper.PermissionHelper;
import bpc.dis.utilities.PermissionHelper.PermissionRequest;
                ...
                .setPermissionResultListener(new PermissionResultListener() {
                    ...
                    public void onPermissionGranted() {
                        ...
                        if (downloadManager != null) {
                            ...
                            activity.registerReceiver(new DownloadReceiver(
